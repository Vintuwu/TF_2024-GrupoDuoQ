            ...
            {estado.nombre === "Preparación" && (
                ...
                <form onSubmit={handleFormSubmit} className='w-full'>
                    ...
                    <div className="mb-4">
                        ...
                        {errors.dias && <p className="text-red-500 text-md mt-1">{errors.dias}</p>}
                    </div>
                    ...
                    {errors.rangosHorarios && <p className="text-red-500 text-md mt-1">{errors.rangosHorarios}</p>}
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            min="1"
                        />
                        {errors.canchas && <p className="text-red-500 text-md mt-1">{errors.canchas}</p>}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            min="1"
                        />
                        {errors.duracionPartido && <p className="text-red-500 text-md mt-1">{errors.duracionPartido}</p>}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        {errors.formatoTorneo && <p className="text-red-500 text-md mt-1">{errors.formatoTorneo}</p>}
                    </div>
                    ...
                    {equiposElegibles.map((equipo) => (
                        <div key={equipo.id} className="flex items-center mb-2">
                            <input
                                ...
                                className="mr-2 rounded border-gray-300 focus:ring-blue-500"
                            />
                            <label htmlFor={"team" + equipo.id} className="text-gray-700">
                                {equipo.nombre}
                            </label>
                        </div>
                    ))}
                    {errors.equiposSeleccionados && <p className="text-red-500 text-md mt-1">{errors.equiposSeleccionados}</p>}
